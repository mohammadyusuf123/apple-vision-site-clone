...
ScrollTrigger.create({
  ...
  // markers:true,
  scroller: `#main`,
//    start end according to preference
  start: `top top`,
  end: `600% top`,
});
}
...
// LogIn  form
let login=document.getElementById('form-container')

function openLoginForm(){
  console.log("click")
  login.classList.add('open-form-container')
}
function closeLoginForm(){
  login.classList.remove('open-form-container')
}